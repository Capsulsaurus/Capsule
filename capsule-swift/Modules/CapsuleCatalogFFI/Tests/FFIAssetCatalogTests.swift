...
struct CapsuleCatalogTests {
    private func makeAsset(
        id: String,
        type: String = "photo",
        captureTimestamp: Int64 = 1720000000,
        hash: String? = nil
    ) -> CatalogAsset {
        CatalogAsset(
            id: id,
    ...
    func softDeleteAndRestore() async throws {
        ...
        try await catalog.softDeleteAsset(id: "trashed", deletedAt: 1720000500)
    ...
    func albumLifecycle() async throws {
        let catalog = try FFIAssetCatalog.inMemory()
        let album = CatalogAlbum(id: "album-1", name: "Trip", createdAt: 1720000000, modifiedAt: 1720000000)
