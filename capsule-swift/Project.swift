...
private let appTarget: Target = .target(
    ...
    infoPlist: .extendingDefault(with: [
        ...
        // the API outright when it is absent — so these values are the base declaration
        // and the en fallback, never the source of truth. Change the wording in
        // `locales/`, then mirror it here.
        "NSPhotoLibraryUsageDescription": // locales/: ios.infoplist.photo_library_usage
            "Capsule shows and organizes the photos and videos in your library.",
        "NSFaceIDUsageDescription": // locales/: ios.infoplist.face_id_usage
